# ===== v32u-ci3state-20260707: CI판정 3상태(ci/check/none) — 상품명 CI/GI/리빙케어 반영, 회색지대 비CI 오분류 차단 =====
...
<div class="app" id="app">
  ...
  <div class="chat" id="chat">
    <div class="msg bot">보장분석지 <b>OCR PDF</b> 또는 <b>TXT</b>를 올려주세요. 엑셀·PPT 파일을 각각 드려요.<br><br>
  ...
  <footer>미래를 <b>바르게</b> 설계합니다 · BARUM <b>v32u-ci3state</b></footer>
</div>
...
@app.get('/health')
def health(): return {'ok':True,'version':'v32u-ci3state-20260707'}
