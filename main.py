...
def parse_txt(txt, filename=''):
    ...
    for _c in deduped:
        ...
        for _k in list(_c['dambo'].keys()):
            ...
            _t2 = _t2.replace('Ⅰ','1').replace('Ⅱ','2').replace('Ⅲ','3')
...
def health():
    ...
    return {'ok':True,'version':'v362-hjheart-20260806',
            'audit': _audit,
...
def version_bot():
    ...
    out = {'server_version': 'v362-hjheart-20260806'}
...
def doctrine_bot():
    ...
    try:
        ...
        cov['검사'] = 'ERR ' + str(e)[:40]
    return {'version': 'v362-hjheart-20260806',
            '지침정본': _DOCTRINE_SRC,
...
def diag():
    ...
    out = {'version': 'v362-hjheart-20260806'}
