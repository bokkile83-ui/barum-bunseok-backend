...
<div class="pg">
 ...
 <div class="body">
  ...
  <div class="note" style="background:transparent;border-left:none;text-align:center;color:{MUT}">※ 충족률은 보유 담보의 영역별 구성 충실도를 상대 비교한 참고 지표이며, 권장 가입액은 상담을 통해 별도 산정합니다</div>
 </div>
